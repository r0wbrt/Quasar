...
SUITE(PlainTextFile)
{
    ...
    {
        Quasar::PlainTextFile txt(Aquila_TEST_TXTFILE, 22050);
    ...
    TEST(SaveArray)
    {
        ...
        Quasar::PlainTextFile::save(data, Aquila_TEST_TXTFILE_OUTPUT);

        Quasar::PlainTextFile txt(Aquila_TEST_TXTFILE_OUTPUT, 22050);
